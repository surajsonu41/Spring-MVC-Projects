...
public class DAOImplementation implements DAO
{
	...
	public int update(StoreBean storeBean) {
		Session session=sessionFactory.openSession();
		Query query=session.createQuery("update StoreBean set storeName=:storeName,storeArea=:storeArea,zipcode=:zipcode,distanceInMiles=:distanceInMiles where storeId=:storeId");
		...
		query.setParameter("zipcode", storeBean.getZipcode());
		query.setParameter("distanceInMiles", storeBean.getDistanceInMiles());
